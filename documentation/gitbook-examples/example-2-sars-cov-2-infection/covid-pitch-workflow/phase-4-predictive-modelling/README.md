...
**Step 2. Navigate to**[ **Predictive**](https://app.gitbook.com/s/9LdC62ZpkxqvCBTPwVZU/data-analysis/predictive) **-> Start**&#x20;
...
1. For this example, we will select families of algorithms especially suitable for biomedical data:
   ...
   3. `Sparse Partial Least Squares`: This method was used in [the paper](https://doi.org/10.1038/s41467-022-28898-1)
   4. `Random Forest`&#x20;
...
**Step 1. Click the&#x20;**<kbd>**Validate data**</kbd>**&#x20;button at the bottom right of the screen**

<figure><img src="../../../.gitbook/assets/CV Phase 4_Validate Data.png" alt=""><figcaption></figcaption></figure>

***

**Step 2. Click the&#x20;**<kbd>**Process**</kbd>**&#x20;button on the pop-up**
